...
$getdata = $db->query("select * from uyeler ORDER BY uye_id DESC");
if(isset($_GET["islem"])== "uyesil"){
  $id= $_GET["id"];
  $deletedata = $db->prepare("DELETE FROM uyeler WHERE uye_id=:id");
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="uye-listesi.php?islem=uyesil&id=<?= $writedata["uye_id"]; ?>" class="btn btn-sm btn-danger">Sil</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
